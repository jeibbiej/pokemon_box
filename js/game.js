...
const _GameVersions =
{
	...
	Ru	: {id: MainSeries +  7,	ico: "custom/ruby",            icoPath: IcoPathRuSa, rDex: {},            nDex: _Regdex_n_301, eDex: _Regdex_e_301, imgWd: ImgWd_G03, maxBox: MaxBox_G03, divBox: DivBox_G03, code: "Ru",   name: "Pokémon Ruby"},
	Sa	: {id: MainSeries +  8,	ico: "custom/sapphire",        icoPath: IcoPathRuSa, rDex: {},            nDex: _Regdex_n_301, eDex: _Regdex_e_301, imgWd: ImgWd_G03, maxBox: MaxBox_G03, divBox: DivBox_G03, code: "Sa",   name: "Pokémon Sapphire"},
	FR	: {id: MainSeries +  9,	ico: "custom/firered_",        icoPath: IcoPathFRLG, rDex: {},            nDex: _Regdex_n_302, eDex: _Regdex_e_302, imgWd: ImgWd_G03, maxBox: MaxBox_G03, divBox: DivBox_G03, code: "FR",   name: "Pokémon FireRed"},
	LG	: {id: MainSeries + 10,	ico: "custom/leafgreen_",      icoPath: IcoPathFRLG, rDex: {},            nDex: _Regdex_n_303, eDex: _Regdex_e_303, imgWd: ImgWd_G03, maxBox: MaxBox_G03, divBox: DivBox_G03, code: "LG",   name: "Pokémon LeafGreen"},
	Em	: {id: MainSeries + 11,	ico: "custom/emerald",         icoPath: IcoPathEm,   rDex: {},            nDex: _Regdex_n_304, eDex: _Regdex_e_304, imgWd: ImgWd_G03, maxBox: MaxBox_G03, divBox: DivBox_G03, code: "Em",   name: "Pokémon Emerald"},
