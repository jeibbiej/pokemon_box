...
const _GameVersions =
{
	...
	Ru	: {id: MainSeries +  7,	ico: "custom/ruby",            icoPath: IcoPathRuSa, rDex: {},            nDex: _Regdex_n_301, eDex: {},            imgWd: ImgWd_G03, maxBox: MaxBox_G03, divBox: DivBox_G03, code: "Ru",   name: "Pokémon Ruby"},
	Sa	: {id: MainSeries +  8,	ico: "custom/sapphire",        icoPath: IcoPathRuSa, rDex: {},            nDex: _Regdex_n_301, eDex: {},            imgWd: ImgWd_G03, maxBox: MaxBox_G03, divBox: DivBox_G03, code: "Sa",   name: "Pokémon Sapphire"},
	FR	: {id: MainSeries +  9,	ico: "custom/firered_",        icoPath: "",          rDex: {},            nDex: _Regdex_n_302, eDex: {},            imgWd: 0,         maxBox: 0,          divBox: 0,          code: "FR",   name: "Pokémon FireRed"},
	LG	: {id: MainSeries + 10,	ico: "custom/leafgreen_",      icoPath: "",          rDex: {},            nDex: _Regdex_n_303, eDex: {},            imgWd: 0,         maxBox: 0,          divBox: 0,          code: "LG",   name: "Pokémon LeafGreen"},
	Em	: {id: MainSeries + 11,	ico: "custom/emerald",         icoPath: "",          rDex: {},            nDex: _Regdex_n_304, eDex: {},            imgWd: 0,         maxBox: 0,          divBox: 0,          code: "Em",   name: "Pokémon Emerald"},
    ...
    vcRe: {id: VirtualConsole + MainSeries + 1,	ico: "custom/vc-red",     icoPath: IcoPathReBl, rDex: {},            nDex: _Regdex_rReBl, eDex: {},            imgWd: ImgWd_G01, maxBox: MaxBox_G01, divBox: DivBox_G01, code: "vcRe", name: "Virtual Console: Pokémon Red"},
	vcBl: {id: VirtualConsole + MainSeries + 2,	ico: "custom/vc-blue",    icoPath: IcoPathReBl, rDex: {},            nDex: _Regdex_rReBl, eDex: {},            imgWd: ImgWd_G01, maxBox: MaxBox_G01, divBox: DivBox_G01, code: "vcBl", name: "Virtual Console: Pokémon Blue"},
	vcYe: {id: VirtualConsole + MainSeries + 3,	ico: "custom/vc-yellow",  icoPath: IcoPathYe,   rDex: {},            nDex: _Regdex_rYe,   eDex: {},            imgWd: ImgWd_G01, maxBox: MaxBox_G01, divBox: DivBox_G01, code: "vcYe", name: "Virtual Console: Pokémon Yellow"},
	vcGo: {id: VirtualConsole + MainSeries + 4,	ico: "custom/vc-gold",    icoPath: IcoPathGoSi, rDex: _Regdex_rGoSi, nDex: _Regdex_nGoSi, eDex: _Regdex_eGoSi, imgWd: ImgWd_G02, maxBox: MaxBox_G02, divBox: DivBox_G02, code: "vcGo", name: "Virtual Console: Pokémon Gold"},
	vcSi: {id: VirtualConsole + MainSeries + 5,	ico: "custom/vc-silver",  icoPath: IcoPathGoSi, rDex: _Regdex_rGoSi, nDex: _Regdex_nGoSi, eDex: _Regdex_eGoSi, imgWd: ImgWd_G02, maxBox: MaxBox_G02, divBox: DivBox_G02, code: "vcSi", name: "Virtual Console: Pokémon Silver"},
	vcCr: {id: VirtualConsole + MainSeries + 6,	ico: "custom/vc-crystal", icoPath: IcoPathCr,   rDex: _Regdex_rCr,   nDex: _Regdex_nGoSi, eDex: _Regdex_eGoSi, imgWd: ImgWd_G02, maxBox: MaxBox_G02, divBox: DivBox_G02, code: "vcCr", name: "Virtual Console: Pokémon Crystal"},
};
