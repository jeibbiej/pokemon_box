...
* For Pokémon with forms:
  ...
  * Formes (or form) should be descriptive. Use these common forms:
    * Mega Evolution: `-mega`, `-mega-x`, `-mega-y`, `-mega-z`
    * Regional variant: `-alola`, `-galar`, `-paldea`
    * Gigantamax: `-gmax`
    * Terastalize: `-tera`
...
* Forms should follow the official indexing. <!-- * Fossil Pokémon should be considered as split evolution from Mysterious Fossil (TCG): `Mysterious Fossil -> Helix Fossil -> Omanyte -> Omastar -> Dome Fossil -> Kabuto -> Kabutops -> Old Amber -> Aerodactyl`. In short, all Fossil Pokémon should be placed after Aerodactyl.-->
...
* If an evolution becomses confusing consider creating an evolution tree like Pikachu's, reading left-to-right, top-to-bottom:
  * ```
    ...
    List   : Pichu
             ...
             Gmax Pikachu
    ------------------------------------------------------------------------
    Gen 9  : Pichu ────────────── Pikachu ─────────┬─ Raichu ───────┬─ Mega Raichu X
                                                   │                └─ Mega Raichu Y
                                                   ├─ Alolan Raichu
                                                   └─ Gmax Pikachu
             Spiky-eared Pichu
    ...
    List   : Pichu
             ...
             Gmax Pikachu
    ------------------------------------------------------------------------
    GenDiff: Pichu ────────────┬─ Pikachu-f ══════╤── Raichu-f ─────┐
                               └─ Pikachu-m ══════╪╤─ Raichu-m ─────┼─ Mega Raichu X
                                                  ││                └─ Mega Raichu Y
                                                  ├┼─ Alolan Raichu
                                                  └┴─ Gmax Pikachu
             Spiky-eared Pichu
